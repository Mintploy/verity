    ...
    items: [
      {
        ...
        a: "One annual membership ($199/year for founding members) gives you 15 safety lookups a month for 12 months, phone intelligence on any number, the Compare feature to evaluate multiple men side by side, PDF export, and 30-day re-run reminders when a report approaches a month old.",
      },
      {
        q: 'Can I cancel?',
