...
function VerifyContent() {
  ...
  if (error) {
    return (
      <div style={{ background: 'var(--pearl)', borderRadius: 'var(--r-xl)', padding: '48px 40px', boxShadow: 'var(--shadow-lg)', textAlign: 'center' }}>
        <h2 style={{ fontFamily: 'var(--serif)', fontSize: 30, color: 'var(--dark)', margin: '0 0 12px', fontWeight: 400 }}>
          {error === 'expired' ? 'Link expired.' : 'Link not valid.'}
        </h2>
        <p style={{ fontFamily: 'var(--sans)', fontSize: 14, color: 'var(--dark-soft)', margin: '0 0 32px', fontWeight: 300, lineHeight: 1.6 }}>
  ...
  return (
    <div style={{ background: 'var(--pearl)', borderRadius: 'var(--r-xl)', padding: '64px 40px', boxShadow: 'var(--shadow-lg)', textAlign: 'center' }}>
      <p style={{ fontFamily: 'var(--serif)', fontStyle: 'italic', fontSize: 24, color: 'var(--dark)', margin: 0 }}>
        Signing you in...
      </p>
    </div>
  );
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--ivory)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 24px' }}>
      <div style={{ width: '100%', maxWidth: 440 }}>
        ...
        <Suspense fallback={<div style={{ background: 'var(--pearl)', borderRadius: 'var(--r-xl)', padding: '64px 40px', boxShadow: 'var(--shadow-lg)', textAlign: 'center' }}><p style={{ fontFamily: 'var(--serif)', fontStyle: 'italic', fontSize: 22, color: 'var(--dark-soft)', margin: 0 }}>Loading...</p></div>}>
          <VerifyContent />
        </Suspense>
      </div>
    </div>
