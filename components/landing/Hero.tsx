      ...
      <div style={{
        ...
        <div>
          ...
          <h1 style={{
            ...
            color: 'var(--plum)', margin: '28px 0 0', letterSpacing: -1.2,
          }}>
            Know him<br />
            <em style={{ color: 'var(--rose)', fontWeight: 300 }}>before</em> you<br />
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 24, marginTop: 36 }}>
            ...
            <div style={{ fontFamily: 'var(--sans)', fontSize: 13.5, color: 'var(--plum-soft)', lineHeight: 1.4 }}>
              <strong style={{ fontWeight: 600, color: 'var(--plum)' }}>47,232 women</strong> already verified ·{' '}
